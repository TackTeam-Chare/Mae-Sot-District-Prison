...
<head>
    ...
    <title>การจัดการข้อมูลระเบียบการเยี่ยมญาติ</title>
...
<body>
    ...
    <div class="container my-5">
        <h1 class="text-center mb-4 fw-bold">การจัดการข้อมูลระเบียบการเยี่ยมญาติ</h1>
        <hr>
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-end">
                                <a href="../edit/edit_regulations_for_visiting_relatives.php?php echo $result['id']; ?>" class="btn btn-warning me-2">Edit</a>
