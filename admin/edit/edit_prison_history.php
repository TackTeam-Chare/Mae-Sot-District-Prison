...
<body>
    ...
    <div class="container my-5">
        ...
        <form id="updateEventForm" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label for="title" class="form-label">หัวเรื่องเนื้อหา</label>
                <input type="text" class="form-control" placeholder="หัวข่าว" name="title" required>
            </div>
            <div class="mb-3">
                <label for="content" class="form-label">เนื้อหาประวัติเรือนจำ</label>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            const eventId = 1; // Get event ID from URL parameter
